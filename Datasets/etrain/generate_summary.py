...
def generate_summary():
    ...
    # Load the data
    try:
        df = pd.read_csv(r'C:\Users\sanya\OneDrive\Desktop\Train-Delay-Predictor\Datasets\etrain\daily_raw.csv', names=[
    ...
    # Save summary to CSV
    summary.to_csv(r'C:\Users\sanya\OneDrive\Desktop\Train-Delay-Predictor\Datasets\etrain\summary.csv', index=False)
